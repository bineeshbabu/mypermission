package com.my.mypermissions.ui;
...
import com.my.mypermissions.utils.MyPermissionBase;
import com.my.mypermissions.utils.ObjectUtils;
...
public class MyPermissionActivity extends AppCompatActivity {
    ...
    private void checkPermissions(boolean fromOnActivityResult) {
        ...
        for (String permission : permissions) {
            if (permission.equals(Manifest.permission.SYSTEM_ALERT_WINDOW)) {
                ...
                if (MyPermissionBase.isDenied(this, permission)) {
                    needPermissions.add(permission);
                }
            }
        }
    ...
    private void permissionResult(List<String> deniedPermissions) {
        Log.v(MyPermission.TAG, "permissionResult(): " + deniedPermissions);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        List<String> deniedPermissions = MyPermissionBase.getDeniedPermissions(this, permissions);
    ...
    public void showPermissionDenyDialog(final List<String> deniedPermissions) {
        ...
        if (hasSettingButton) {
            ...
            if (TextUtils.isEmpty(settingButtonText)) {
                settingButtonText = getString(R.string.mypermission_setting);
            }

            builder.setPositiveButton(settingButtonText, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    MyPermissionBase.startSettingActivityForResult(MyPermissionActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case MyPermissionBase.REQ_CODE_REQUEST_SETTING:
